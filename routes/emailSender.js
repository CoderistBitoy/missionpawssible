...
router.post('/send-email', async function(req, res, next) {
  try {
    ...
    var subject = 'Your Surrender Application Has Been ' + status;
    var htmlTemplate = `
    <html>
    <head>
      <style>
    ...
    <body>
      <div class="container">
        ${status === "Accepted"
          ...
          <p>Dear Owner,</p>
          <p>We are thrilled to inform you that your recent application for Surrender on Mission PAWSsible has been accepted! 🎉</p>
          ...
          <p>Dear Owner,</p>
          <p>We regret to inform you that your recent application for Surrender on Mission PAWSsible has been rejected. Unfortunately, we are unable to proceed with your application at this time.</p>
          ...
          <p>We appreciate your understanding and thank you for considering Mission PAWSsible for your surrender journey.</p>
          <p><strong>Best Regards,</strong></p>
          <p><em>Mission PAWSsible 🐾</em></p>
          `
        }
