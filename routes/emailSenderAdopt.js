...
router.post('/send-email-adopt', async function(req, res, next) {
  try {
    var email = req.body.email;
    var status = req.body.status; // 'Accepted' or 'Rejected' or other status
    var subject = 'Your Pet Adoption Application Has Been ' + status + "🐾";
    var htmlTemplate = `
    <html>
    <head>
      <style>
    ...
    <body>
      <div class="container">
        ${status === "Accepted"
          ...
          <p>Dear Adopter,</p>
          <p>We are thrilled to inform you that your recent application for Adoption on Mission PAWSsible has been accepted! 🎉</p>
          ...
          <p>Dear Adopter,</p>
          <p>We regret to inform you that your recent application for Adoption on Mission PAWSsible has been rejected. Unfortunately, we are unable to proceed with your application at this time.</p>
          ...
          <p>We appreciate your understanding and thank you for considering Mission PAWSsible for your adoption journey.</p>
          <p><strong>Best Regards,</strong></p>
          <p><em>Mission PAWSsible 🐾</em></p>
          `
        }
